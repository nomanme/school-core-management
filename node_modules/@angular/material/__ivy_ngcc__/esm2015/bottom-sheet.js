...
MatBottomSheetContainer.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatBottomSheetContainer, selectors: [["mat-bottom-sheet-container"]], viewQuery: function MatBottomSheetContainer_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, hostAttrs: ["tabindex", "-1", "role", "dialog", 1, "mat-bottom-sheet-container"], hostVars: 2, hostBindings: function MatBottomSheetContainer_HostBindings(rf, ctx) { if (rf & 1) {
...
MatBottomSheet.ɵfac = function MatBottomSheet_Factory(t) { return new (t || MatBottomSheet)(ɵngcc0.ɵɵinject(ɵngcc4.Overlay), ɵngcc0.ɵɵinject(ɵngcc0.Injector), ɵngcc0.ɵɵinject(MatBottomSheet, 12)); };
MatBottomSheet.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MatBottomSheet, factory: MatBottomSheet.ɵfac });
/** @nocollapse */
...
MatBottomSheetModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MatBottomSheetModule_Factory(t) { return new (t || MatBottomSheetModule)(); }, providers: [MatBottomSheet], imports: [[
            CommonModule,
            OverlayModule,
            MatCommonModule,
            PortalModule,
