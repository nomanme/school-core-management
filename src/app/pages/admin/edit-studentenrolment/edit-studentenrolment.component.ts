...
export class EditStudentenrolmentComponent implements OnInit {
  ...
  studentEnrolmentId;
  getstudentenrolment;
  editstudentenrolment = { studentEnrolmentId: null, studentId: null,  studentOriginId: null,  agentId: null,  courseIntakeDateId: null,  applicationStatusId: null,  deliveryModeId: null,  fundingSourceNationalId: null,  fundingSourceStateId: null,  commencingProgramId: null,  trainingContractid: null,  reasonTakingCourseId: null,  applyForRPL: null,  TuitionFee: null, userId: null};
  ...
  ngOnInit(): void {
    ...
    this.apiService.getAPI5('dev/getcourse').subscribe((data)=>{
      console.log(data);
      this.getcourse=data;
    })
